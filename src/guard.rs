use crate::{
    body_parts::body_part_config, categories::category_config, equipment::equipment_config,
    exercises::exercises_config, favorite_meals::route::favorite_meals_config,
    favorite_workouts::favorite_workouts_config, leaderboards::route::leaderboards_config,
    me::me_config, meal_plans::meal_plans_config, meals::meals_config,
    programme_progress::programme_progress_config, programmes::programmes_config,
    statistics::statistics_config, upload::route::upload_config, users::route::user_config,
    workout_progress::workout_progress_config, workouts::workouts_config,
};
